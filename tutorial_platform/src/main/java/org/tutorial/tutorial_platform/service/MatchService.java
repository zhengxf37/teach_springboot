...
public interface MatchService {
    ...
    Student saveStudentWithVector(Student student);
    Teacher saveTeacherWithVector(Teacher teacher);

    /**
     * 根据学生的匹配条件（如科目、年级）获取 AI 排序后的教师列表
     *
     * @param dto 前端传入的匹配参数，包含分页信息及筛选条件
     * @return 分页结果，包含按相似度排序的教师 VO 列表
     */
    Page<MatchTeacherVO> findTeachersWithAiRanking(MatchStudentDTO dto);
     ...
     */
    Page<MatchStudentVO> findStudentsWithAiRanking(MatchTeacherDTO dto);
}
