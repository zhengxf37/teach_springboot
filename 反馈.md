...
3访问`/api/file/list`GET接口，返回文件列表：

![image-20250525152112299](./反馈.assets/image-20250525152112299.png)
...
注意：上传视频感觉占用高且效果差，暂时限制上传多个图片，多个文档，大小限制10mb，放在`/teach_springboot/upload_data/{userid}`下（后端目录）
